...
<body>
    <nav>
        ...
        <ul>
           <li><a href="journal.php" >Journal Publication</a></li>
            ...
            <li><a href="patent.php" id="pat">Patents</a></li>
    ...
    <div class="container">
        ...
        <form action="patent.php" method="post">
            ...
            &emsp;<input type="radio" name="drcrecommendation" id=""  > Recommended &emsp;
            <input type="radio" name="drcrecommendation" id="" > Not Recommended<br><br>
...
$sdg = $_POST["sdg"];
$drcrecommendation = $_POST["drcrecommendation"];
