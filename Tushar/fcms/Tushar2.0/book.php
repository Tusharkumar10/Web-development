...
<body>
    ...
    <div class="container">
        ...
        <form action="book.php" method="post">
            ...
            <input type="text"  name="facultyname " class="demo" placeholder="Enter faculty name"><br><br>
...
if (isset($_POST["submit"])) {
    ...
    $sql = "insert into booktbl values('$facultyname','$facultyid','$department ,'$booktitle ,'$affiliation','$publisher','$editionnumber','$publicationdate,'$publishertype','$bookeditors','$editorsid','$bookindexing','$sdg','$collaboration','$personsname','$outsideinstitutions','$weblink','$proof','$drc')"; 
